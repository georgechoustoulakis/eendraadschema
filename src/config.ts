export const CONFIGPAGE_LEFT:string = `
    <br>
...
export const CONFIGPAGE_RIGHT:string = `
          <br><br>
        </td>
        <td width="25%" align="center">
          <br>
